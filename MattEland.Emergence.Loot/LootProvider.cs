...
namespace MattEland.Emergence.Loot
{
    public class LootProvider : ILootProvider
    {
        ...
        public void SpawnLootAsNeeded(ICommandContext context, IGameObject source, Rarity rarity)
        {
        ...
        public void SpawnLoot(ICommandContext context, IGameObject source, Rarity rarity)
        {
        ...
        private static bool LootAlreadyExists(ICommandContext context, LootEntry entry)
        {
