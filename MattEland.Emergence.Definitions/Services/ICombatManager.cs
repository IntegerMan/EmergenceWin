...
namespace MattEland.Emergence.Definitions.Services
{
    public interface ICombatManager
    {
        ...
        void HandleAttack(ICommandContext context, IGameObject attacker, IGameObject defender, string verb, DamageType damageType);
        ...
        string HurtObject(ICommandContext context, IGameObject defender, int damage, IGameObject attacker, string verb, DamageType damageType);

        void HandleExplosion(ICommandContext context, IGameObject executor, Pos2D epicenter, int strength, int radius, DamageType damageType);
        ...
        void HandleCapture(ICommandContext context, IGameObject defender, IGameObject attacker);
    }
}