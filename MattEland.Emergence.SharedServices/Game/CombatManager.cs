...
namespace MattEland.Emergence.Services.Game
{
    ...
    public class CombatManager : ICombatManager
    {
        ...
        public void HandleAttack(ICommandContext context, IGameObject attacker, IGameObject defender, string verb, DamageType damageType)
        {
        ...
        private static int CalculateDamage(ICommandContext context, IGameObject attacker, IGameObject defender, string verb)
        {
        ...
        public string HurtObject(ICommandContext context, IGameObject defender, int damage, IGameObject attacker, string verb, DamageType damageType)
        {
        ...
        public void HandleExplosion(ICommandContext context, IGameObject executor, Pos2D epicenter, int strength, int radius, DamageType damageType)
        {
        ...
        public void HandleCapture(ICommandContext context, IGameObject defender, IGameObject attacker)
        {
        ...
        private static bool DetermineIfAttackHits(ICommandContext context, IGameObject attacker, IGameObject defender)
        {
