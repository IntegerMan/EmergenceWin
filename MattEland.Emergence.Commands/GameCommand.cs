...
namespace MattEland.Emergence.Commands
{
    ...
    public abstract class GameCommand : IGameCommand
    {
        ...
        /// <inheritdoc />
        public bool Execute(ICommandContext context, IActor executor, Pos2D pos, bool isCurrentlyActive)
        {
        ...
        protected virtual void OnActivated(ICommandContext context, IActor executor, Pos2D pos)
        {
        }

        protected virtual void OnDeactivated(ICommandContext context, IActor executor, Pos2D pos)
        {
        }
        ...
        public abstract void ApplyEffect(ICommandContext context, IActor executor, Pos2D pos);


        public virtual void ApplyPreActionEffect(ICommandContext context, IActor executor, Pos2D pos)
        {
